...
for $r in doc('xml/converted/e/religion_e.xml')//religion-tuple[name='Buddhist']/country
for $c in doc('xml/converted/e/country_e.xml')//country-tuple[code=$r]
let $member := doc('xml/converted/e/ismember_e.xml')//ismember-tuple[country=$c/code]/organization
for $o in doc('xml/converted/e/organization_e.xml')//organization-tuple[abbreviation=$member and established > '1994-12-01']
return concat($c/name, " ---- ", $o/name)